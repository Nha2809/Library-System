              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="img/avatar-1.jpg" alt="..." class="img-fluid">
                    ...
                    <h3 class="h5">Jake</h3><span>@Jakey</span></a>
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="img/avatar-4.jpg" alt="..." class="img-fluid">
                    ...
                    <h3 class="h5">Jungwon</h3><span>@jungwonie</span></a>
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="img/avatar-6.jpg" alt="..." class="img-fluid">
                    ...
                    <h3 class="h5">Jaay</h3><span>@Jaay</span></a>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="img/avatar-1.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Lisa</strong><span class="d-block">@lisaa</span></a>
                </div>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="img/avatar-2.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Bailu</strong><span class="d-block">@bailu</span></a>
                </div>
                <div class="col-lg-4 text-center">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="img/avatar-6.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Fan Cheng Cheng</strong><span class="d-block">@chenchen</span></a>
                </div>
                <div class="col-lg-4 text-center">
